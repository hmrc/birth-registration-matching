...
//  override val app: Map[String, _] = new GuiceApplicationBuilder().configure(
//    Map(
//    "metrics.jvm" -> false,
...
//  val auditConfigOnAppForDefault: Application = GuiceApplicationBuilder()
//    .disable[com.kenshoo.play.metrics.PlayModule]
//    .configure(auditConfigOnForDefault)
//    .build()

//  val auditConfigOnAppForAlternate: Application = GuiceApplicationBuilder()
//    .disable[com.kenshoo.play.metrics.PlayModule]
...
//    .build()
  ...
  "RequestsAndResultsAudit" should {
    ...
    "return correct default settings for audit config" in {
...
//    "return correct settings when audit config is overridden" in {
